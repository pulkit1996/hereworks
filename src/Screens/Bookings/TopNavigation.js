...
const TopNavigation = props => {
  ...
  useEffect(() => {
    ...
    const listenerId = scrollA.addListener(a => {
      const topNaviOffset = BANNER_HEIGHT - TOPNAVI_HEIGHT - safeArea.top;
...
const styles = {
  container: (safeArea, isFloating, isTransparent) => ({
    ...
    marginBottom: isFloating ? -TOPNAVI_HEIGHT - safeArea.top : 0,
    height: TOPNAVI_HEIGHT + safeArea.top,
